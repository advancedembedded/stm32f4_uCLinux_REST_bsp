...
#if defined(CONFIG_STM32_I2C1) && defined(CONFIG_TOUCHSCREEN_STMPE)
	unsigned int v;
#endif
...
# endif
	...
	case PLATFORM_STM32_STM_REST_V1:
...
#error		IOMUX for STM32 SPI1 undefined
		...
		gpio_dsc.port = 4;	/* INT of Touch Panel */
		gpio_dsc.pin  = 4;
