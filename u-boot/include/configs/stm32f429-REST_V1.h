 ...
 * Monitor prompt
 */
#define CONFIG_SYS_PROMPT		"STM32F429-REST> "
...
#define CONFIG_BOOTARGS	"stm32_platform=stm-REST-V1 "\
				"console=ttyS0,921600 panic=10"
#define LOADADDR		"0xC0007FC0"

#define REV_EXTRA_ENV		\
	"envmboot=run args;bootm ${loadaddr}\0"	
